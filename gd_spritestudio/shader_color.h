//static const String shader_color = R"(
static const char* shader_color = R"(
/*!
* \file		shader_color.gdshader
...
{
//	return	getBlendColor( col, texture( tex, st ) );
	return	getBlendColor( col, ssTextureSample( tex, st ) );
}
