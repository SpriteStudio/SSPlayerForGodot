...
#ifndef FLATBUFFERS_GENERATED_SSQB_SS_FORMAT_H_
#define FLATBUFFERS_GENERATED_SSQB_SS_FORMAT_H_
...
struct Sequence FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  ss::format::SequenceType type() const {
    return static_cast<ss::format::SequenceType>(GetField<uint8_t>(VT_TYPE, 0));
  }
  const ::flatbuffers::Vector<::flatbuffers::Offset<ss::format::SequenceItem>> *list() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<ss::format::SequenceItem>> *>(VT_LIST);
  }
  template <bool B = false>
  bool Verify(::flatbuffers::VerifierTemplate<B> &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct SequenceBuilder {
  ...
  void add_type(ss::format::SequenceType type) {
    fbb_.AddElement<uint8_t>(Sequence::VT_TYPE, static_cast<uint8_t>(type), 0);
  }
  void add_list(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<ss::format::SequenceItem>>> list) {
...
inline ::flatbuffers::Offset<Sequence> CreateSequenceDirect(
  ...
  auto list__ = list ? _fbb.CreateVector<::flatbuffers::Offset<ss::format::SequenceItem>>(*list) : 0;
...
inline const ss::format::SsSequenceBinary *GetSsSequenceBinary(const void *buf) {
  return ::flatbuffers::GetRoot<ss::format::SsSequenceBinary>(buf);
}

inline const ss::format::SsSequenceBinary *GetSizePrefixedSsSequenceBinary(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<ss::format::SsSequenceBinary>(buf);
}
...
inline bool VerifySsSequenceBinaryBuffer(
  ...
  return verifier.template VerifyBuffer<ss::format::SsSequenceBinary>(SsSequenceBinaryIdentifier());
}

template <bool B = false>
inline bool VerifySizePrefixedSsSequenceBinaryBuffer(
    ::flatbuffers::VerifierTemplate<B> &verifier) {
  return verifier.template VerifySizePrefixedBuffer<ss::format::SsSequenceBinary>(SsSequenceBinaryIdentifier());
}
...
inline void FinishSsSequenceBinaryBuffer(
    ...
    ::flatbuffers::Offset<ss::format::SsSequenceBinary> root) {
...
#endif  // FLATBUFFERS_GENERATED_SSQB_SS_FORMAT_H_
