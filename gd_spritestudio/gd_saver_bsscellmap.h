/*!
* \file		gd_saver_bsscellmap.h
* \author	CRI Middleware Co., Ltd.
*/
#ifndef GD_SAVER_BSSCELLMAP_H
#define GD_SAVER_BSSCELLMAP_H
...
class GdSaverBssCellMap : public ResourceFormatSaver
{
	GDCLASS( GdSaverBssCellMap, ResourceFormatSaver );
