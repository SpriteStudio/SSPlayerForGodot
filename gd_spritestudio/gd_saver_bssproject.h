/*!
* \file		gd_saver_bssproject.h
* \author	CRI Middleware Co., Ltd.
*/
#ifndef GD_SAVER_BSSPROJECT_H
#define GD_SAVER_BSSPROJECT_H
...
class GdSaverBssProject : public ResourceFormatSaver
{
	GDCLASS( GdSaverBssProject, ResourceFormatSaver );
