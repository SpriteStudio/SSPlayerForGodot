...
*   **シームレスな統合と高速イテレーション:** Godot のエディタ内に統合された「SS Import Dock」による簡単なインポートに加え、インスペクタから直接 SpriteStudio を開いて再コンバートできる**シームレスなアセット更新ワークフロー**を提供します。詳しくは [USAGE: エディタ連携とアセットイテレーション](workflow/usage_asset_pipeline.md) をご覧ください。
