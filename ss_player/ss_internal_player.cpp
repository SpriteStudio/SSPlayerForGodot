...
// per-frame realloc) across the common case of a continuously-animating mask.
int ss_quantize_coverage_dim(float px, int min_dim, int max_dim) {
    int v = (int)std::ceil(px);
    if (v <= min_dim) return min_dim;
